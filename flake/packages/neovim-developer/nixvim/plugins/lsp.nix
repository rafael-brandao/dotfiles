  ...
  mkMerge [
    {
      plugins = {
        ...
        # lsp-lines.enable = true; # TODO: disable when nixvim supports the tiny-inline-diagnostic-nvim plugin
        ...
        conform-nvim = {
          ...
          settings = {
            ...
            formatters = with pkgs; {
              ...
              deadnix.command = "${getExe deadnix} --edit";
              jsonfmt.command = "${getExe jsonfmt} -w";
              ...
              toml-sort.command = "${getExe toml-sort} -i";
